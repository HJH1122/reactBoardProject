...
import com.hjh.board_back.dto.response.search.GetRelationListResponseDto;
...
public class SearchController {
    ...
    public ResponseEntity<? super GetRelationListResponseDto> gerRelationList(@PathVariable("searchWord") String searchWord) {
