        ...
        <div className='footer-container'>
            <div className='footer-top'>
                <div className='footer-logo-box'>
                    ...
                    <div className='footer-logo-text'>{'HJH Board'}</div>
                </div>
                <div className='footer-link-box'>
                    <div className='footer-email-link'>{'abc123@gmail.com'}</div>
            ...
            <div className='footer-bottom'>
                <div className='footer-copylight'>{'Copyright 2025 HJH. All Right Reserved.'}</div>
            </div>
        </div>
    </div>
  )
